    ...
    <><>
          <ProductsForm />
              ...
              <CardGroup style={{ width: '65rem', height: '40rem' }}>
                  <Card>
                      <Card.Img variant="top" style={{ height: '220px' }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaFPTO7FxJ64kt3kDzkK2MSZKHEBR0n_dQiA&usqp=CAU" />
                  ...
                  <Card>
                      ...
                      <Card.Img variant="top" style={{ height: '220px' }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJlEAPhN6C94gkUOUbKhMuuQeWRoYwWp9k0g&usqp=CAU" />
                  ...
                  <Card>
                      <Card.Img variant="top" style={{ height: '220px' }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS67jLCNl53c7trrWIPocGTsYMUxR6GrgeAwA&usqp=CAU" />

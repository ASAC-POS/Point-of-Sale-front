    ...
    <>
      <Container>
        ...
        <Row
          xs={1}
          md={6}
          className='align-items-start gap-5 flex-row vision-container'
        >
          ...
          >
            <p style={{ width: '100%' }}>
              ...
              <br /> to become globally recognized as the POS system to go with.
            </p>
          </Col>
        </Row>
      </Container>
      <Container>
        ...
        >
          <Col
            md={6}
            className='mission-des flex-row'
            style={{ width: '100%' }}
          >
            <p style={{ width: '100%' }}>
              {' '}

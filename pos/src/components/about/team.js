      ...
      <Row xs={1} md={6} className='align-items-start gap-5 flex-row'>
        <Col className='card gap-2'>
          ...
          <div className='card-body'>
            ...
            <div className='card-social-icon d-flex gap-3 justify-content-center'>
              <a href='https://www.facebook.com/jalal.sahoory'>
                <i className='fa-brands fa-facebook-f'>
                  <BsFacebook />
                </i>
              </a>
              <a href='https://github.com/JalalHasan-22'>
                <i className='fa-brands fa-github'>
                  <BsGithub />
                </i>
              </a>
              <a href='https://www.linkedin.com/in/jalal-hasan-160bba211'>
        ...
        <Col className='card gap-2'>
          ...
          <div className='card-body'>
            ...
            <p className='card-text'>Software Developer</p>
            <div className='card-social-icon d-flex gap-3 justify-content-center'>
              <a href='https://www.facebook.com/leen.karaja.3'>
                <i className='fa-brands fa-facebook-f'>
                  <BsFacebook />
                </i>
              </a>
              ...
              <a href='https://www.linkedin.com/in/leen-karaja'>
                <i className='fa-brands fa-linkedin-in'>
                  <BsLinkedin />
                </i>
              </a>
        ...
        <Col className='card  gap-2'>
          ...
          <div className='card-body'>
            ...
            <p className='card-text'>Software Developer</p>
            <div className='card-social-icon d-flex gap-3 justify-content-center'>
              <a href='https://www.facebook.com/manalalbahar91'>
                <i className='fa-brands fa-facebook-f'>
                  <BsFacebook />
                </i>
              </a>
        ...
        <Col className='card gap-2'>
          ...
          <div className='card-body'>
            ...
            <p className='card-text'>Software Developer</p>
            <div className='card-social-icon d-flex gap-3 justify-content-center'>
              <a href='https://web.facebook.com/mhsalameh1?_rdc=1&_rdr'>
                <i className='fa-brands fa-facebook-f'>
                  <BsFacebook />
                </i>
              </a>
              <a href='https://github.com/Mhsalameh'>
                <i className='fa-brands fa-github'>
                  <BsGithub />
                </i>
              </a>
              <a href='https://www.linkedin.com/in/mhsalameh'>
                <i className='fa-brands fa-linkedin-in'>
                  <BsLinkedin />
                </i>
              </a>
        ...
        <Col className='card gap-2 '>
          ...
          <div className='card-body'>
            ...
            <p className='card-text'>Software Developer</p>
            <div className='card-social-icon d-flex gap-3 justify-content-center'>
              <a href='https://www.facebook.com/profile.php?id=100010016567120 '>
                <i className='fa-brands fa-facebook-f'>
                  <BsFacebook />
                </i>
              </a>
              <a href='https://github.com/neveenaburomman'>
                <i className='fa-brands fa-github'>
                  <BsGithub />
                </i>
              </a>
              <a href='http://www.linkedin.com/in/neveenaburomman-9a23851aa'>
                <i className='fa-brands fa-linkedin-in'>
                  <BsLinkedin />
                </i>
              </a>
